          ...
          <div className="github-Review">
            ...
            <details className="github-Review-thread" open>
              ...
              <main className="github-Review-comments">
                ...
                <div className="github-Review-controls">
                  <label className='github-Review-checkbox input-label'><input className='input-checkbox' type='checkbox' />Mark as resolved</label>
                </div>
              </main>
            </details>
