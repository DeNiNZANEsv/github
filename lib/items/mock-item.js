          ...
          <div className="github-Review">
            ...
            <details className="github-Review-thread" open>
              <summary className="github-Review-threadHeader">
                <input className="github-Review-checkbox input-checkbox" type='checkbox' />
              ...
              <main className="github-Review-comments">
                <div className="github-Review-comment">
                  ...
                  <div className="github-Review-commentText">Mind adding a space after the comma?</div>
                </div>
                <div className="github-Review-comment">
                  <img className="github-Review-avatar" src="../../github/img/avatars/14.png"/>
                  <span className="github-Review-timeAgo">1 minute ago</span>
                  <div className="github-Review-commentText">Thanks, right.</div>
                </div>
            ...
            <details className="github-Review-thread is-resolved">
              <summary className="github-Review-threadHeader">
                <input className="github-Review-checkbox input-checkbox" type='checkbox' defaultChecked />
                <span className="github-Review-path">lib/repository-states/</span>
                <span className="github-Review-file">present.js</span>
                <span className="github-Review-line">350</span>
              </summary>
              <main className="github-Review-comments">
                <div className="github-Review-comment">
                  ...
                  <div className="github-Review-commentText">Great solution! 🤘</div>
                </div>
              </main>
            </details>
            ...
            <details className="github-Review-thread is-resolved">
              ...
              <main className="github-Review-comments">
                <div className="github-Review-comment">
                  ...
                  <div className="github-Review-commentText">I think we should only release this as a patch.</div>
                </div>
              </main>
            </details>
            ...
            <details className="github-Review-thread is-resolved">
              ...
              <main className="github-Review-comments">
                <div className="github-Review-comment">
                  <img className="github-Review-avatar" src="../../github/img/avatars/04.png"/>
                  <span className="github-Review-timeAgo">4 days ago</span>
                  <div className="github-Review-commentText">Why not use just a plain 64-bit integer?</div>
                </div>
                <div className="github-Review-comment">
                  <img className="github-Review-avatar" src="../../github/img/avatars/14.png"/>
                  <span className="github-Review-timeAgo">4 days ago</span>
                  <div className="github-Review-commentText">Hm, good point, I was worried about some ORMs that register lots of classes, but I just calculated that it will take million years to reach the maximum value even if 1000 classes are registered every second.</div>
                </div>
              </main>
            </details>
